...
local goalTapeSettings = {
    ...
    mainSFX = SFX.open(Misc.resolveFile("goalTape_orb.ogg")),        -- The sound played when hitting the goal tape. Can be nil for none, a number for a vanilla sound, or a sound effect object/string for a custom sound.
